  ...
  stages {
    ...
    stage('Deploy to GKE cluster') {
      steps {
          ...
          step([$class: 'KubernetesEngineBuilder', namespace:'test', projectId: , clusterName: params.GKE_CLUSTER_NAME, zone: params.GKE_ZONES, manifestPattern: './deployment', credentialsId: "sa-gcr-image", verifyDeployments: true])
        }
      }
